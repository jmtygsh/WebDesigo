...
const AnimatedItem = ({ item, index }) => {
    ...
    }, { scope: cardRef }); // Scope ensures animations are tied to this specific card
...
export const ServiceCard = ({ data }) => {
    ...
    return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-[90%] md:max-w-full m-auto">
            {data.map((item, index) => (
